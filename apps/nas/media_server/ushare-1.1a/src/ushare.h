...
#define DEFAULT_SERIAL_NUM "DLNA-SERVER-001"

#define UPNP_MAX_CONTENT_LENGTH 4096

#define STARTING_ENTRY_ID_DEFAULT 0
#define STARTING_ENTRY_ID_XBOX360 100000
#define STARTING_ENTRY_ID_STEP 10000
#define STARTING_ENTRY_ID_CYCLE 32
...
"    <modelDescription>%s : UPnP Media Server</modelDescription>" \
...
extern void rebuild_list_lock();

extern void rebuild_list_unlock();
