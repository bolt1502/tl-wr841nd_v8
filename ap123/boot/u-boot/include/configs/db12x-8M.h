...
#			define CONFIG_EXTRA_ENV_SETTINGS		\
			"dir=\0"					\
			BC						\
			"lu=tftp 0x81000000 ${dir}u-boot.bin&&"		\
			"erase 0x9f000000 +$filesize;"			\
			"cp.b $fileaddr 0x9f000000 $filesize\0"		\
			"lf=tftp 0x81000000 ${dir}${bc}-squashfs&&"	\
			"erase 0x9f120000 +$filesize;"			\
			"cp.b $fileaddr 0x9f120000 $filesize\0"		\
			""
			/*
